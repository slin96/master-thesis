...
#  to make the output smaller we also changes the probing code of the mmlib
...
#     GRAD_INPUT_TENSOR = 'grad_inp'
#     GRAD_OUTPUT_SHAPE = 'grad_output_shape'
#     GRAD_OUTPUT_TENSOR = 'grad_out'
#
#
...
#             if value_ == 'AdaptiveAvgPool2d':
#                 value_ = 'AAvgP2d'
#             if value_ == 'BatchNorm2d':
#                 value_ = 'BNorm2d'
#             if value_ == 'BasicConv2d':
#                 value_ = 'BcConv2d'
...
#         for comp in compare:
#             header_fields.append(comp.value + '')
