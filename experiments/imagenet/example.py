...
if __name__ == '__main__':
    ...
    imagnet_val_data = datasets.ImageNet(imagenet_root, 'val', transform=inference_transforms)
    ...
    imagenet_train_data = datasets.ImageNet(imagenet_root, 'val', transform=train_transforms)
    ...
    print('imagenet val')
    img_val_output = validate(model, imagnet_val_data, loss_func, get_outputs=True, number_batches=num)
    print('coco val')
